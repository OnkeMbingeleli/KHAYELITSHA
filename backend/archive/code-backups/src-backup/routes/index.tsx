    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
          CODETA replaces shouting matches at the rank with a simple system: marshals log every load,
        ...
        <section className="mt-20 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: QrCode, t: "QR stickers", d: "Round CODETA stickers identify each vehicle by route, plate, owner and seats." },
